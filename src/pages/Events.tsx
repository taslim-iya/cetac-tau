  ...
  return (
    <div style={{ padding: '32px 40px' }}>
      <div style={{ marginBottom: 24 }}>
        ...
        <p style={{ fontSize: 14, color: 'var(--text-2)', marginTop: 2 }}>{events.length} events across 9 weeks</p>
      </div>
      <DataTable
        columns={COLUMNS}
        data={events}
        ...
        onAdd={() => add('events', { name: '', description: '', date: '', time: '', venue: '', week: 1, status: 'planned', speakers: [], sponsors: [], attendeeCount: 0, format: '', postEventNotes: '', checklist: [] })}
        addLabel="Add Event"
        entityName="events"
